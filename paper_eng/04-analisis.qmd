...
ccoef_rewb_int <- list(
  "protesta_within"                                                = "Within-person (ref. = High School)",
  "educ_cat_unorderedTechnical College incomplete:protesta_within" = "\\hspace{1em}$\\times$ Technical College incomplete",
  "educ_cat_unorderedTechnical College complete:protesta_within"   = "\\hspace{1em}$\\times$ Technical College complete",
  "educ_cat_unorderedUniversity incomplete:protesta_within"        = "\\hspace{1em}$\\times$ University incomplete",
  "educ_cat_unorderedUniversity complete:protesta_within"          = "\\hspace{1em}$\\times$ University complete",
  "protesta_mean"                                                  = "Between-person (ref. = High School)",
  "educ_cat_unorderedTechnical College incomplete:protesta_mean"   = "\\hspace{1em}$\\times$ Technical College incomplete",
  "educ_cat_unorderedTechnical College complete:protesta_mean"     = "\\hspace{1em}$\\times$ Technical College complete",
  "educ_cat_unorderedUniversity incomplete:protesta_mean"          = "\\hspace{1em}$\\times$ University incomplete",
  "educ_cat_unorderedUniversity complete:protesta_mean"            = "\\hspace{1em}$\\times$ University complete"
)
...
These results also address a potential concern about the power of within-person estimates: of the 3,627 individuals in the analytical sample, 1,262 (34.8%) changed participation status at least once across waves, and within-person variation accounts for 54.8% of total participation variance. The within-null for state violence in Model 3b therefore cannot be attributed to insufficient variation in participation across waves.
